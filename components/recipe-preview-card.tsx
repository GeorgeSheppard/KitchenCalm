...
export function RecipePreviewCard({ recipe }: { recipe: Recipe }) {
  ...
  return (
    <Card className="group overflow-hidden border-border/60 shadow-sm transition-shadow hover:shadow-md cursor-pointer">
      <div className="flex flex-col sm:flex-row">
        <div className="relative aspect-[4/3] w-full sm:aspect-square sm:w-48 shrink-0 overflow-hidden">
          <Image
            src={recipe.image}
            alt={recipe.title}
            fill
